...
pub static audio_file_list: [&str; 10] = [
    r"C:\Users\cschneiderwind\Documents\MATLAB\Test signals\vogeljagd_long_150_16000_normal.wav",
    r"C:\Users\cschneiderwind\Documents\MATLAB\Test signals\vogeljagd_long_150_16000_normal.wav",
    "2",
    "3",
    "4",
...
// pub static audio_file_list: [&str; 10] = [
//     r"E:\RustProjects\Assets\_Stimuli__speech__HarvardMale.wav",
//     r"E:\RustProjects\Assets\MaleSpeechGerman_DieFuenfteWelle_48kHz.wav",
//     "2",
//     "3",
//     "4",
//     "5",
...
fn read_angles() {
    ...
    let (fst, ftt) =
        FilterStorage::new(Path::new(rel_hrtfs), Path::new(rel_angles), &mut fftm, 128);
